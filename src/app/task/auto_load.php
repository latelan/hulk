...
function getClassPath()
{
    ...
    {
        $classpath = apc_fetch("hulk_task:1425455977");
        if ($classpath) return $classpath;

        $classpath = getClassMapDef();
        apc_store("hulk_task:1425455977",$classpath); 
    }
    else if(function_exists("eaccelerator_get"))
    {
        $classpath = eaccelerator_get("hulk_task:1425455977");
        if ($classpath) return $classpath;

        $classpath = getClassMapDef();
        eaccelerator_put("hulk_task:1425455977",$classpath); 
    }
    else
    {
        $classpath = getClassMapDef();
